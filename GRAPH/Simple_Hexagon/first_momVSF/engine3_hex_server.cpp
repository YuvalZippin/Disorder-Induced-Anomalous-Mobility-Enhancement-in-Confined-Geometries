// engine3_hex_server.cpp
// PRO-Grade Subordination Engine for Geometry B (Hexagonal) - Force (F) Dependence
// Optimized for Dual Intel Xeon E5-2683 v4 (O(1) Binomial Leap + Dynamic Scheduling)
// Compile: g++ -std=c++17 -O3 -march=broadwell -fopenmp -o engine3_hex_server engine3_hex_server.cpp
// Run:     export OMP_NUM_THREADS=64 && ./engine3_hex_server
...
namespace Config {
    ...
    const std::string CSV_FILE = "results_graph_a_hex.csv";
}
...
int main() {
    ...
    std::cout << "[SYSTEM] Initializing Engine 3 Hexagonal (Force Dependence - Server Edition)\n";
