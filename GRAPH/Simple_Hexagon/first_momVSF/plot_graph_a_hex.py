#!/usr/bin/env python3
# plot_graph_a_hex.py
# Usage: python3 plot_graph_a_hex.py --csv results_graph_a_hex.csv --alpha 0.3 --out graph_a_hex_exact.png
...
def main():
    ap = argparse.ArgumentParser(description="Plot exact analytical scaling vs Simulation for Geometry B (Force)")
    ap.add_argument("--csv", required=True, default="results_graph_a_hex.csv", help="Input CSV")
    ap.add_argument("--alpha", type=float, default=0.3, help="Anomalous exponent")
    ap.add_argument("--out", default="graph_a_hex_exact.png", help="Output filename")
    args = ap.parse_args()
