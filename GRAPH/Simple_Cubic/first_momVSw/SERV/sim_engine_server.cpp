...
// Compile: g++ -std=c++17 -O3 -march=broadwell -fopenmp -o sim_engine_server sim_engine_server.cpp
// run: export OMP_NUM_THREADS=64 && ./sim_engine_server
